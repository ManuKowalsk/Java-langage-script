...
/******************************* Interpreter *******************************************************/
	...
	public Executeur(String script) {
		GSpace space = new GSpace("Fenetre d'execution", new Dimension(600, 400));
		space.open();
		...
		this.mainLoop(script);
	}
	
	private void mainLoop(String script) {
			// prompt
			System.out.print("> ");
